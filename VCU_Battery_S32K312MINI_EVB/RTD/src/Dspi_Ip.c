...
#define DSPI_IP_AR_RELEASE_MINOR_VERSION_C       9
#define DSPI_IP_AR_RELEASE_REVISION_VERSION_C    0
#define DSPI_IP_SW_MAJOR_VERSION_C               7
#define DSPI_IP_SW_MINOR_VERSION_C               0
#define DSPI_IP_SW_PATCH_VERSION_C               1
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
void Dspi_Ip_IrqHandler(uint8 Instance)
{
    ...
    IrqEnabled = Base->RSER & (DSPI_RSER_TCF_RE_MASK | DSPI_RSER_RFOF_RE_MASK | DSPI_RSER_DDIF_RE_MASK);
    ...
    else
    {
        ...
        Base->SR &= ((0xFFFF0000u & (~(DSPI_SR_TCF_MASK | DSPI_SR_RFOF_MASK | DSPI_SR_DDIF_MASK))) | IrqEnabled);
    }
}
