...
#define FLEXIO_SPI_IP_AR_RELEASE_MINOR_VERSION_C       9
#define FLEXIO_SPI_IP_AR_RELEASE_REVISION_VERSION_C    0
#define FLEXIO_SPI_IP_SW_MAJOR_VERSION_C               7
                              ...
                              uint8 ShifterErrMaskFlag)
{
    ...
    {
        if(NULL_PTR != Flexio_Spi_Ip_apxStateStructureArray[Count])
        {
    ...
    else
    {
        ...
        /* clearing all flags will be done in MCL driver */
    }
}
