...
#define SPI_IPW_AR_RELEASE_MINOR_VERSION_C        9
#define SPI_IPW_AR_RELEASE_REVISION_VERSION_C     0
#define SPI_IPW_SW_MAJOR_VERSION_C                7
...
static boolean Spi_Ipw_AreDeviceParamsCompatible(const Lpspi_Ip_ExternalDeviceType *ExternalDevice,
...
#endif
{
    ...
    /* Validates the compatibility of device parameters with channel configuration */
