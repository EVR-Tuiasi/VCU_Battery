...
#define DSPI_IP_AR_RELEASE_MINOR_VERSION_CFG        9
#define DSPI_IP_AR_RELEASE_REVISION_VERSION_CFG     0
#define DSPI_IP_SW_MAJOR_VERSION_CFG                7
#define DSPI_IP_SW_MINOR_VERSION_CFG                0
#define DSPI_IP_SW_PATCH_VERSION_CFG                1
...
#endif
    /* Check if Dspi_Ip_BOARD_INITPERIPHERALS_PBcfg header file and Spi  configuration header file are of the same Autosar version */
...
#endif
/* Check if Dspi_Ip_BOARD_INITPERIPHERALS_PBcfg header file and Spi configuration header file are of the same software version */
