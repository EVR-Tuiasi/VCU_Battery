...
#define LPSPI_IP_AR_RELEASE_MINOR_VERSION_PBCFG_C         9
#define LPSPI_IP_AR_RELEASE_REVISION_VERSION_PBCFG_C      0
#define LPSPI_IP_SW_MAJOR_VERSION_PBCFG_C                 7
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_1 =
{
    ...
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
        ...
        (uint32)(LPSPI_CCR_SCKPCS(119U) | LPSPI_CCR_PCSSCK(119U)), /* ccr */
        (uint32)(LPSPI_CCR1_SCKSCK(118U) | LPSPI_CCR1_PCSPCS(59U) | LPSPI_CCR1_SCKHLD(59U) | LPSPI_CCR1_SCKSET(59U)), /* ccr1 */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(1U) | LPSPI_TCR_CPHA(1U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(3U) | LPSPI_TCR_CONT(1U)) /* TCR */
