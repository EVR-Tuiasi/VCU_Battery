...
*
*/
static const Adc_ChannelType Adc_Group4_Assignment_0[ADC_CFGSET_GROUP_4_CHANNELS] =
{
    3U
};
...
*
*/
static const Adc_ChannelType Adc_Group6_Assignment_1[ADC_CFGSET_GROUP_6_CHANNELS] =
{
    2U
};
...
*
*/
static const Adc_ChannelType Adc_Group7_Assignment_1[ADC_CFGSET_GROUP_7_CHANNELS] =
{
    3U
};
...
#endif /* (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON) */
        /**< @brief Channels assigned to the group*/
        Adc_Group4_Assignment_0, /* AssignmentPtr */
        /**< @brief Number of channels in the group*/
...
#endif /* (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON) */
        /**< @brief Channels assigned to the group*/
        Adc_Group6_Assignment_1, /* AssignmentPtr */
        /**< @brief Number of channels in the group*/
        (Adc_ChannelIndexType)ADC_CFGSET_GROUP_6_CHANNELS, /* AssignedChannelCount */
        /**< @brief Last Channel configured */
...
#endif /* (ADC_CTU_HW_TRIGGER_OPTIMIZATION == STD_ON) */
#if (ADC_SET_ADC_CONV_TIME_ONCE == STD_OFF)
        &AdcIpwGroupConfig_6 /* AdcIpwGroupConfigPtr */
        #endif /* (ADC_SET_ADC_CONV_TIME_ONCE == STD_OFF) */
    },
...
#endif /* (ADC_ENABLE_GROUP_STREAMING_RESULTS_REORDER == STD_ON) */
        /**< @brief Channels assigned to the group*/
        Adc_Group7_Assignment_1, /* AssignmentPtr */
        /**< @brief Number of channels in the group*/
        (Adc_ChannelIndexType)ADC_CFGSET_GROUP_7_CHANNELS, /* AssignedChannelCount */
        /**< @brief Last Channel configured */
...
#endif /* (ADC_CTU_HW_TRIGGER_OPTIMIZATION == STD_ON) */
#if (ADC_SET_ADC_CONV_TIME_ONCE == STD_OFF)
        &AdcIpwGroupConfig_7 /* AdcIpwGroupConfigPtr */
        #endif /* (ADC_SET_ADC_CONV_TIME_ONCE == STD_OFF) */
    }
};
