...
#define FLEXIO_SPI_IP_AR_RELEASE_MINOR_VERSION_PBCFG_C         9
#define FLEXIO_SPI_IP_AR_RELEASE_REVISION_VERSION_PBCFG_C      0
#define FLEXIO_SPI_IP_SW_MAJOR_VERSION_PBCFG_C                 7
...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Flexio_Spi_Ip_PBcfg source file and Spi configuration header file are of the same vendor */
