...
#define CAN_HTH_INVERTOR_STANGA				13U
#define CAN_HTH_INVERTOR_DREAPTA			14U
#define CAN_HTH_INVERTOARE					15U
#define CAN_HTH_BORD						16U
#define CAN_HTH_ACCELERATIE					17U
#define CAN_HTH_FRANA						18U
#define CAN_HTH_BATERIE						19U
#define CAN_HTH_BATERIE_TENSIUNI_CELULE		20U
#define CAN_HTH_BATERIE_TEMPERATURI_CELULE	21U
#define CAN_HTH_BATERIE_2					22U
#define CAN_HTH_BATERIE_CHARGER				23U
#define CAN_HTH_COMUNICATII					24U
#define CAN_HTH_CHARGER						25U
...
void Can_Receive_Interrupt_CHARGER(PduIdType RxPduId, const PduInfoType * PduInfoPtr){
	(void)RxPduId;
	(void)PduInfoPtr;
}
...
void Can_Transmit_Interrupt_CHARGER(void){
