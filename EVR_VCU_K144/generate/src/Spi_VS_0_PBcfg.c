...
static Spi_DataBufferType Spi_BufferTX_VS_0_SpiChannel_0[4];
static Spi_DataBufferType Spi_BufferRX_VS_0_SpiChannel_0[4];
...
static Spi_BufferDescriptorType Spi_Buffer_VS_0_SpiChannel_0 =
{
    ...
    Spi_BufferTX_VS_0_SpiChannel_0,  /* BufferTX */
    Spi_BufferRX_VS_0_SpiChannel_0   /* BufferRX */
};
...
static const Spi_JobConfigType Spi_JobConfig_SpiJob_0_VS_0 =
{
        ...
        &Spi_aExternalDeviceConfigList_VS_0[SPI_SpiExternalDevice_0] /* ExternalDeviceConfig - pointer to the external device configuration */
};
